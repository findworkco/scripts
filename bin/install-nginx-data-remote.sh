...
rsync -havz --chmod=0000 "$crt_path" "$target_host":"findwork.co.crt"
rsync -havz --chmod=0000 "$key_path" "$target_host":"findwork.co.key"
...
sudo chown root:root findwork.co.crt findwork.co.key dhparam.pem
sudo chmod u=rwx,g=rwx,o=rwx findwork.co.crt
sudo chmod u=r,g=,o= findwork.co.key dhparam.pem
